    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `dark:placeholder-text-neutral-600 duration-400 flex h-10 w-full rounded-md border-none bg-bg px-3 py-2 text-sm text-bg shadow-input  transition file:border-0 
